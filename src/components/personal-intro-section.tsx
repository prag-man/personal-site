...
export default function PersonalIntroSection() {
  ...
  return (
    <section className="min-h-[90vh] flex flex-col-reverse lg:flex-row px-20">
      ...
      >
        <div className="max-w-lg">
          <h1 className="text-4xl lg:text-5xl font-bold text-[#1E293B] mb-2">
            pragyam soni 
          </h1>
          <h3 className='text-xl text-[#1E293B]/60 font-semibold'>(aka pragman)</h3>
          <div className="space-y-6 text-[#1E293B] leading-relaxed mt-5">
            <p className="text-lg">
              hi, i'm pragman, 19 and clueless. figuring out my existence while acting as a self-taught dev, building stuff on the net that, hopefully, make a quiet difference.
            </p>
            <p className="text-lg">
              [ashamedly] i am a total addict to - chess, dreaming, diet coke, overthinking (ofc), failing, procastination, ♾️.
            </p>
            <p className="text-lg">
